...
class SDPEERIDException : public SDException{
public:
	SDPEERIDException(const std::string& what) : SDException(what){};
};
...
class command_tablenoexist_exception : public SDException{
public:
	command_tablenoexist_exception(const std::string& what) : SDException(what){};
};
